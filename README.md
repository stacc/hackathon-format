...
![](https://media.giphy.com/media/bUrIry2zSgjny/giphy.gif)
...
A `lab` is an event where people find solutions to problems defined within a scope or _theme_.
...
![jury](https://media.giphy.com/media/q8nUWmWcqmO9q/giphy.gif)
...
![welcome](https://media.giphy.com/media/eoVusT7Pi9ODe/giphy.gif)
...
![ugh](https://media.giphy.com/media/pVAMI8QYM42n6/giphy.gif)

---

Optionally this can be a short introduction to the _theme_
...
![brain storm](https://media.giphy.com/media/2bYewTk7K2No1NvcuK/giphy.gif)
...
Allow for 10-20 minutes of discussion and writing down ideas. There are no requirements as to quantity or quality. These should be _one-liner_ notes that explains the idea. Every table/participant can write as many or as few as they want. Most likely there will be overlaps and duplicate ideas, and these will be amassed in the next part.
...
![presentation](https://media.giphy.com/media/3o7qDEq2bMbcbPRQ2c/giphy.gif)

In this part, the participants present their ideas to the entire `lab`. This can be done either with every participant presenting their individual ideas or the table assinging a _presenter_ to go through each. The latter will be faster.

Allow each table 5 minutes to present all ideas. _Rememeber_ that these are one-liners and not product presentations.
...
![team](https://media.giphy.com/media/3o7aDaA9obiRkaS7lu/giphy.gif)
...
![innovate](https://media.giphy.com/media/ARb77MvJVd7Uc/giphy.gif)
...
Allow 10 minute / team presentation. Most likely this will overflow. ![cause it can](https://media.giphy.com/media/nzpmpriSmAEog/giphy.gif)
...
Each tea
_NOTE_: allow for enough time for presentation. At least 2 hours before the end. Do _NOT_ set it to be 1 hour before days end. This will lead to people not getting to present because they need to pick up children or other engagements.
...
![bye](https://media.giphy.com/media/7DzlajZNY5D0I/giphy.gif)
